...
function spamla(){
	...
	if (message.channel.id = "798927855731081218"){ //NİTROYU ATACAĞI KANALIN İDSİ
...
client.login('Nzk0ODUzNTQ5NjQ0NDQ3Nzc1.X_A3DQ.EoVp2y2Q9633rPqv6quwAKOrnuA'); //BURAYA BOTUN TOKENİNİ YAZ
